    ...
    <div className="card-standard overflow-hidden hover:shadow-md transition-shadow">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/3 p-9 text-center md:text-left">
          <div className="w-28 h-28 md:w-36 md:h-36 bg-gray-500 rounded-full flex items-center justify-center mx-auto md:mx-0 mb-7">
          ...
          <p className="body-medium text-gray-500 font-semibold">
            {member.title}
          </p>
        </div>

        {/* Bio Section - Right Side */}
        <div className="md:w-2/3 p-9 border-t md:border-t-0 md:border-l border-dark-light/30">
