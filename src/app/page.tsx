...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="container-standard">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="card-standard text-center">
              ...
              <h3 className="heading-4 text-white">Property Company</h3>
              <p className="body-small text-gray-300 mt-2">Real Estate & Development</p>
            </div>
            ...
            <div className="card-standard text-center">
              ...
              <h3 className="heading-4 text-white">Operating Company</h3>
              <p className="body-small text-gray-300 mt-2">Truck Parking Operations</p>
            </div>
            ...
            <div className="card-standard text-center">
              ...
              <h3 className="heading-4 text-white">Technology Company</h3>
              <p className="body-small text-gray-300 mt-2">Technology Platform</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-standard">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card-elevated h-full flex flex-col">
              <div className="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
                <DollarSign className="w-6 h-6 text-white" />
              </div>
              <h3 className="heading-4 text-white mb-3 leading-tight">
                PRIVATE INVESTORS WITH A HISTORY OF SUCCESS
              </h3>
              <p className="body-medium text-gray-300 flex-1">
            ...
            {/* Safety and Security */}
            <div className="bg-gray-700 rounded-xl p-6 shadow-lg border border-gray-600 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] h-full flex flex-col">
              <div className="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
            ...
            <div className="bg-gray-700 rounded-xl p-6 shadow-lg border border-gray-600 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] h-full flex flex-col">
              <div className="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
                <SpeedIcon className="w-6 h-6 text-white" />
              </div>
              <h3 className="heading-4 text-white mb-3 leading-tight">
      ...
      {/* CTA Section */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-600">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/truck-parking"
              className="bg-gray-800 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-700 transition-colors inline-flex items-center justify-center shadow-lg"
            >
              Learn More
            ...
            <a
              ...
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-500 transition-colors inline-flex items-center justify-center shadow-lg"
            >
              Contact Us
            </a>
          </div>
